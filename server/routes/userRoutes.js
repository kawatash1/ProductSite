...
const User = require('C:/Users/madks/Documents/FullStack/Project 3/server/models/userModel.js');
...
router.post('/logout', async (req, res, next) => {
  ...
  // Если refreshToken не передан в теле запроса, проверяем cookies
  ...
  try {
    // 1. Очистка refreshToken на сервере (если токен хранится в базе данных)
    // Обновляем запись пользователя, делая refreshToken равным null
    ...
    // 2. Очистка refreshToken из cookies (если хранится в cookies)
